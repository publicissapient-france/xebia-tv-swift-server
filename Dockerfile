...
RUN apt-get update && \
    apt-get install -y python-setuptools python3-pip python-dev build-essential wget clang-3.6 curl libedit-dev python2.7 python2.7-dev libicu52 rsync libxml2 git && \
...
RUN pip3 install -U livestreamer 
